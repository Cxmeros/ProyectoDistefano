...
if (isset($_SESSION['pedido']) && $_SESSION['pedido'] = 'complete'): ?>
	...
	<br/>
	<?php unset($_SESSION['carrito']); unset($_SESSION['pedido']); if (isset($pedido)): ?>
		<h3>Datos del pedido:</h3>

		Número de pedido: <?= $pedido->id ?>   <br/>
		Nombre de quien encargó: <?= $usuario->nombre?> <?= $usuario->apellidos?><br/>
...
<?php unset($_SESSION['pedido']); endif; ?>